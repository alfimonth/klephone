                                ...
                                <form class="center col-md-12" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="password col-sm-6 mb-4 mb-sm-0">
                                            <input type="text" required class="form form-control" name="ram" id="ram" />
                                            <label for="ram" class="label">RAM</label>
                                            <?= form_error('ram',  '<small class="text-danger">', '</small>') ?>
                                        </div>
                                        <div class="password col-sm-6">
                                            <input type="text" required class="form form-control" name="rom" id="rom" />
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="password col-sm-6 mb-4 mb-sm-0">
                                            <input type="text" required class="form form-control" name="bcam" id="bcam" />
                                            <label for="bcam" class="label">Main cam</label>
                                            <?= form_error('bcam',  '<small class="text-danger">', '</small>') ?>
                                        </div>
                                        <div class="password col-sm-6">
                                            <input type="text" required class="form form-control" name="fcam" id="fcam" />
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="password col-sm-6 mb-4 mb-sm-0">
                                            <input type="text" required class="form form-control" name="harga" id="harga" />
                                            <label for="harga" class="label">Harga</label>
                                            <?= form_error('harga',  '<small class="text-danger">', '</small>') ?>
                                        </div>
                                        <div class="password col-sm-6">
                                            <input type="text" required class="form form-control" name="stok" id="stok" />
