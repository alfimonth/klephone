                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="center col-md-12" method="POST" action="">
                                    ...
                                    <div class="email mb-4">
                                        <input type="text" required class="form form-control" name="tlp" id="tlp" aria-describedby="emailHelp" value="<?= $cos['tlp'] ?>" />
                                        <label for="tlp" class="label">Telepon</label>
                                        <?= form_error('tlp',  '<small class="text-danger">', '</small>') ?>
                                    </div>
                                    <div class="email mb-4">
                                        <textarea type="text" class="form form-control" name="catatan" id="catatan" aria-describedby="emailHelp"><?= $cos['catatan'] ?></textarea>
